...
// DRAM
#define DRAM_CHANNELS 1      // default: assuming one DIMM per one channel 8GB * 2 => 16GB off-chip memory
#define LOG2_DRAM_CHANNELS 0
#define DRAM_RANKS 1         // 8GB * 1 ranks => 8GB per DIMM
#define LOG2_DRAM_RANKS 0
#define DRAM_BANKS 8         // 1GB * 8 banks => 8GB per rank
#define LOG2_DRAM_BANKS 3
#define DRAM_ROWS 262144    // 8KB * 128K rows => 1GB per bank
#define LOG2_DRAM_ROWS 18
#define DRAM_COLUMNS 128      // 64B * 128 column chunks (Assuming 1B DRAM cell * 8 chips * 8 transactions = 64B size of column chunks) => 8KB per row
