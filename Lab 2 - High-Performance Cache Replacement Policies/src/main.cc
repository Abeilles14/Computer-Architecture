...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
    ...
    cout << " ------------ " << endl;
    cout << "ROI_" << cpu << cache->NAME << "TOTAL_ACCESS : " << setw(10) << TOTAL_ACCESS << endl << "ROI_" << cpu << cache->NAME <<"TOTAL_HITS : " << setw(10) << TOTAL_HIT << endl << "ROI_" << cpu << cache->NAME <<"TOTAL_MISSES : " << setw(10) << TOTAL_MISS << endl << "ROI_" << cpu << cache->NAME <<"TOTAL_HITRATE : " << setw(10) << ((double)TOTAL_HIT)/TOTAL_ACCESS << endl;
    
    cout << endl;
    cout << "ROI_" << cpu << cache->NAME <<"LOAD_ACCESS : " << setw(10) << cache->roi_access[cpu][0] << endl << "ROI_" << cpu << cache->NAME <<"LOAD_HITS : " << setw(10) << cache->roi_hit[cpu][0] << endl << "ROI_" << cpu << cache->NAME <<"LOAD_MISSES : " << setw(10) << cache->roi_miss[cpu][0] << endl << "ROI_" << cpu << cache->NAME <<"LOAD_HITRATE : " << setw(10) << ((double)cache->roi_hit[cpu][0])/cache->roi_access[cpu][0] << endl;
    
    cout << endl;
    cout << "ROI_" << cpu << cache->NAME <<"RFO_ACCESS : " << setw(10) << cache->roi_access[cpu][1] << endl << "ROI_" << cpu << cache->NAME << "RFO_HITS : " << setw(10) << cache->roi_hit[cpu][1] << endl << "ROI_" << cpu << cache->NAME<< "RFO_MISSES : " << setw(10) << cache->roi_miss[cpu][1] << endl << "ROI_" << cpu << cache->NAME<< "RFO_HITRATE : " << setw(10) << ((double)cache->roi_hit[cpu][1])/cache->roi_access[cpu][1] << endl;
    
    cout << endl;
    cout << "ROI_" << cpu << cache->NAME << "PREFETCH_ACCESS : " << setw(10) << cache->roi_access[cpu][2] << endl << "ROI_" << cpu << cache->NAME << "PREFETCH_HITS : " << setw(10) << cache->roi_hit[cpu][2] << endl << "ROI_" << cpu << cache->NAME << "PREFETCH_MISSES : " << setw(10) << cache->roi_miss[cpu][2] << endl << "ROI_" << cpu << cache->NAME << "PREFETCH_HITRATE : " << setw(10) << ((double)cache->roi_hit[cpu][2])/cache->roi_access[cpu][2] << endl;
    
    cout << endl;
    cout << "ROI_" << cpu << cache->NAME << "WRITEBACK_ACCESS : " << setw(10) << cache->roi_access[cpu][3] << endl << "ROI_" << cpu << cache->NAME << "WRITEBACK_HITS : " << setw(10) << cache->roi_hit[cpu][3] << endl <<  "ROI_" << cpu << cache->NAME << "WRITEBACK_MISSES : " << setw(10) << cache->roi_miss[cpu][3] << endl << "ROI_" << cpu << cache->NAME << "WRITEBACK_HITRATE : " << setw(10) << ((double)cache->roi_hit[cpu][3])/cache->roi_access[cpu][3] << endl;
    
    cout << endl;
    cout << "ROI_" << cpu << cache->NAME <<"PREFETCH_REQUESTED : " << setw(10) << cache->pf_requested << endl <<  "ROI_" << cpu << cache->NAME<< "PREFETCH_ISSUED : " << setw(10) << cache->pf_issued << endl <<  "ROI_" << cpu << cache->NAME << "PREFETCH_USEFUL : " << setw(10) << cache->pf_useful << endl <<  "ROI_" << cpu << cache->NAME << "PREFETCH_USELESS : " << setw(10) << cache->pf_useless << endl << "ROI_" << cpu << cache->NAME << "PREFETCH_ISSUED_REQ_RATIO : " << setw(10) << ((double)cache->pf_issued)/cache->pf_requested << endl << "ROI_" << cpu << cache->NAME << "PREFETCH_USEFUL_USELESS_RATIO : " << setw(10) << ((double)cache->pf_useful)/cache->pf_useless << endl ;
    
    cout << endl;
    cout << "ROI_" << cpu << cache->NAME <<"AVERAGE_MISS_LATENCY : " << (1.0*(cache->total_miss_latency))/TOTAL_MISS  << endl;
    cout << " ------------ " << endl;
}
...
void print_sim_stats(uint32_t cpu, CACHE *cache)
{
    ...
    cout << " ------------ " << endl;
    cout << "SIM_" << cpu << cache->NAME << "TOTAL_ACCESS : " << setw(10) << TOTAL_ACCESS << endl << "SIM_" << cpu << cache->NAME <<"TOTAL_HITS : " << setw(10) << TOTAL_HIT << endl << "SIM_" << cpu << cache->NAME <<"TOTAL_MISSES : " << setw(10) << TOTAL_MISS << endl << "SIM_" << cpu << cache->NAME <<"TOTAL_HITRATE : " << setw(10) << ((double)TOTAL_HIT)/TOTAL_ACCESS << endl;
    
    cout << endl;
    cout << "SIM_" << cpu << cache->NAME <<"LOAD_ACCESS : " << setw(10) << cache->sim_access[cpu][0] << endl << "SIM_" << cpu << cache->NAME <<"LOAD_HITS : " << setw(10) << cache->sim_hit[cpu][0] << endl << "SIM_" << cpu << cache->NAME <<"LOAD_MISSES : " << setw(10) << cache->sim_miss[cpu][0] << endl << "SIM_" << cpu << cache->NAME <<"LOAD_HITRATE : " << setw(10) << ((double)cache->sim_hit[cpu][0])/cache->sim_access[cpu][0] << endl;
    
    cout << endl;
    cout << "SIM_" << cpu << cache->NAME <<"RFO_ACCESS : " << setw(10) << cache->sim_access[cpu][1] << endl << "SIM_" << cpu << cache->NAME << "RFO_HITS : " << setw(10) << cache->sim_hit[cpu][1] << endl << "SIM_" << cpu << cache->NAME<< "RFO_MISSES : " << setw(10) << cache->sim_miss[cpu][1] << endl << "SIM_" << cpu << cache->NAME<< "RFO_HITRATE : " << setw(10) << ((double)cache->sim_hit[cpu][1])/cache->sim_access[cpu][1] << endl;
    
    cout << endl;
    cout << "SIM_" << cpu << cache->NAME << "PREFETCH_ACCESS : " << setw(10) << cache->sim_access[cpu][2] << endl << "SIM_" << cpu << cache->NAME << "PREFETCH_HITS : " << setw(10) << cache->sim_hit[cpu][2] << endl << "SIM_" << cpu << cache->NAME << "PREFETCH_MISSES : " << setw(10) << cache->sim_miss[cpu][2] << endl << "SIM_" << cpu << cache->NAME << "PREFETCH_HITRATE : " << setw(10) << ((double)cache->sim_hit[cpu][2])/cache->sim_access[cpu][2] << endl;
    
    cout << endl;
    cout << "SIM_" << cpu << cache->NAME << "WRITEBACK_ACCESS : " << setw(10) << cache->sim_access[cpu][3] << endl << "SIM_" << cpu << cache->NAME << "WRITEBACK_HITS : " << setw(10) << cache->sim_hit[cpu][3] << endl <<  "SIM_" << cpu << cache->NAME << "WRITEBACK_MISSES : " << setw(10) << cache->sim_miss[cpu][3] << endl << "SIM_" << cpu << cache->NAME << "WRITEBACK_HITRATE : " << setw(10) << ((double)cache->sim_hit[cpu][3])/cache->sim_access[cpu][3] << endl;
    cout << " ------------ " << endl;
}

void print_roi_stats_llc(CACHE *cache)
{
    uint64_t TOTAL_ACCESS = 0, TOTAL_HIT = 0, TOTAL_MISS = 0;
    uint64_t LOAD_ACCESS = 0, LOAD_HIT = 0, LOAD_MISS = 0;
    uint64_t RFO_ACCESS = 0, RFO_HIT = 0, RFO_MISS = 0;
    uint64_t PREFETCH_ACCESS = 0, PREFETCH_HIT = 0, PREFETCH_MISS = 0;
    uint64_t WRITEBACK_ACCESS = 0, WRITEBACK_HIT = 0, WRITEBACK_MISS = 0;
    
    for(uint32_t j=0; j<NUM_CPUS; j++) {
        for (uint32_t i=0; i<NUM_TYPES; i++) {
            TOTAL_ACCESS += cache->roi_access[j][i];
            TOTAL_HIT += cache->roi_hit[j][i];
            TOTAL_MISS += cache->roi_miss[j][i];
        }
        LOAD_ACCESS += cache->roi_access[j][0];
        LOAD_HIT += cache->roi_hit[j][0];
        LOAD_MISS += cache->roi_miss[j][0];

        RFO_ACCESS += cache->roi_access[j][1];
        RFO_HIT += cache->roi_hit[j][1];
        RFO_MISS += cache->roi_miss[j][1];

        PREFETCH_ACCESS += cache->roi_access[j][2];
        PREFETCH_HIT += cache->roi_hit[j][2];
        PREFETCH_MISS += cache->roi_miss[j][2];

        WRITEBACK_ACCESS += cache->roi_access[j][3];
        WRITEBACK_HIT += cache->roi_hit[j][3];
        WRITEBACK_MISS += cache->roi_miss[j][3];

    }
    
    cout << " ------------ " << endl;
    cout << "ROI_"  << cache->NAME << "TOTAL_ACCESS : " << setw(10) << TOTAL_ACCESS << endl << "ROI_"  << cache->NAME <<"TOTAL_HITS : " << setw(10) << TOTAL_HIT << endl << "ROI_"  << cache->NAME <<"TOTAL_MISSES : " << setw(10) << TOTAL_MISS << endl << "ROI_"  << cache->NAME <<"TOTAL_HITRATE : " << setw(10) << ((double)TOTAL_HIT)/TOTAL_ACCESS << endl;
    
    cout << endl;
    cout << "ROI_"  << cache->NAME <<"LOAD_ACCESS : " << setw(10) << LOAD_ACCESS << endl << "ROI_"  << cache->NAME <<"LOAD_HITS : " << setw(10) << LOAD_HIT << endl << "ROI_"  << cache->NAME <<"LOAD_MISSES : " << setw(10) << LOAD_MISS << endl << "ROI_"  << cache->NAME <<"LOAD_HITRATE : " << setw(10) << ((double)LOAD_HIT)/LOAD_ACCESS << endl;
    
    cout << endl;
    cout << "ROI_"  << cache->NAME <<"RFO_ACCESS : " << setw(10) << RFO_ACCESS << endl << "ROI_"  << cache->NAME << "RFO_HITS : " << setw(10) << RFO_HIT << endl << "ROI_"  << cache->NAME<< "RFO_MISSES : " << setw(10) << RFO_MISS << endl << "ROI_"  << cache->NAME << "RFO_HITRATE : " << setw(10) << ((double)RFO_HIT)/RFO_ACCESS << endl;
    
    cout << endl;
    cout << "ROI_"  << cache->NAME << "PREFETCH_ACCESS : " << setw(10) << PREFETCH_ACCESS << endl << "ROI_"  << cache->NAME << "PREFETCH_HITS : " << setw(10) << PREFETCH_HIT << endl << "ROI_"  << cache->NAME << "PREFETCH_MISSES : " << setw(10) << PREFETCH_MISS << endl << "ROI_"  << cache->NAME << "PREFETCH_HITRATE : " << setw(10) << ((double)PREFETCH_HIT)/PREFETCH_ACCESS << endl;
    
    cout << endl;
    cout << "ROI_"  << cache->NAME << "WRITEBACK_ACCESS : " << setw(10) << WRITEBACK_ACCESS << endl << "ROI_"  << cache->NAME << "WRITEBACK_HITS : " << setw(10) << WRITEBACK_HIT << endl <<  "ROI_"  << cache->NAME << "WRITEBACK_MISSES : " << setw(10) << WRITEBACK_MISS << endl << "ROI_"  << cache->NAME << "WRITEBACK_HITRATE : " << setw(10) << ((double)WRITEBACK_HIT)/WRITEBACK_ACCESS << endl;
    
    cout << endl;
    cout << "ROI_"  << cache->NAME <<"PREFETCH_REQUESTED : " << setw(10) << cache->pf_requested << endl <<  "ROI_"  << cache->NAME<< "PREFETCH_ISSUED : " << setw(10) << cache->pf_issued << endl <<  "ROI_"  << cache->NAME << "PREFETCH_USEFUL : " << setw(10) << cache->pf_useful << endl <<  "ROI_"  << cache->NAME << "PREFETCH_USELESS : " << setw(10) << cache->pf_useless << endl << "ROI_"  << cache->NAME << "PREFETCH_ISSUED_REQ_RATIO : " << setw(10) << ((double)cache->pf_issued)/cache->pf_requested << endl << "ROI_"  << cache->NAME << "PREFETCH_USEFUL_USELESS_RATIO : " << setw(10) << ((double)cache->pf_useful)/cache->pf_useless << endl ;
    
    cout << endl;
    cout << "ROI_"  << cache->NAME <<"AVERAGE_MISS_LATENCY : " << (1.0*(cache->total_miss_latency))/TOTAL_MISS  << endl;
    cout << " ------------ " << endl;
}

void print_sim_stats_llc(CACHE *cache)
{
    uint64_t TOTAL_ACCESS = 0, TOTAL_HIT = 0, TOTAL_MISS = 0;
    uint64_t LOAD_ACCESS = 0, LOAD_HIT = 0, LOAD_MISS = 0;
    uint64_t RFO_ACCESS = 0, RFO_HIT = 0, RFO_MISS = 0;
    ...
    for(uint32_t j=0; j<NUM_CPUS; j++) {
        for (uint32_t i=0; i<NUM_TYPES; i++) {
            TOTAL_ACCESS += cache->sim_access[i][i];
            TOTAL_HIT += cache->sim_hit[j][i];
            TOTAL_MISS += cache->sim_miss[j][i];
        }
        LOAD_ACCESS += cache->sim_access[j][0];
        LOAD_HIT += cache->sim_hit[j][0];
        LOAD_MISS += cache->sim_miss[j][0];

        RFO_ACCESS += cache->sim_access[j][1];
        RFO_HIT += cache->sim_hit[j][1];
        RFO_MISS += cache->sim_miss[j][1];

        PREFETCH_ACCESS += cache->sim_access[j][2];
        PREFETCH_HIT += cache->sim_hit[j][2];
        PREFETCH_MISS += cache->sim_miss[j][2];

        WRITEBACK_ACCESS += cache->sim_access[j][3];
        WRITEBACK_HIT += cache->sim_hit[j][3];
        WRITEBACK_MISS += cache->sim_miss[j][3];
    }
    cout << " ------------ " << endl;
    cout << "SIM_"  << cache->NAME << "TOTAL_ACCESS : " << setw(10) << TOTAL_ACCESS << endl << "SIM_"  << cache->NAME <<"TOTAL_HITS : " << setw(10) << TOTAL_HIT << endl << "SIM_"  << cache->NAME <<"TOTAL_MISSES : " << setw(10) << TOTAL_MISS << endl << "SIM_"  << cache->NAME <<"TOTAL_HITRATE : " << setw(10) << ((double)TOTAL_HIT)/TOTAL_ACCESS << endl;
    
    cout << endl;
    cout << "SIM_"  << cache->NAME <<"LOAD_ACCESS : " << setw(10) << LOAD_ACCESS << endl << "SIM_"  << cache->NAME <<"LOAD_HITS : " << setw(10) << LOAD_HIT << endl << "SIM_"  << cache->NAME <<"LOAD_MISSES : " << setw(10) << LOAD_MISS << endl << "SIM_"  << cache->NAME <<"LOAD_HITRATE : " << setw(10) << ((double)LOAD_HIT)/LOAD_ACCESS << endl;
    
    cout << endl;
    cout << "SIM_"  << cache->NAME <<"RFO_ACCESS : " << setw(10) << RFO_ACCESS << endl << "SIM_"  << cache->NAME << "RFO_HITS : " << setw(10) << RFO_HIT << endl << "SIM_"  << cache->NAME<< "RFO_MISSES : " << setw(10) << RFO_MISS << endl << "SIM_"  << cache->NAME<< "RFO_HITRATE : " << setw(10) << ((double)RFO_HIT)/RFO_ACCESS << endl;
    
    cout << endl;
    cout << "SIM_"  << cache->NAME << "PREFETCH_ACCESS : " << setw(10) << PREFETCH_ACCESS << endl << "SIM_"  << cache->NAME << "PREFETCH_HITS : " << setw(10) << PREFETCH_HIT << endl << "SIM_"  << cache->NAME << "PREFETCH_MISSES : " << setw(10) << PREFETCH_MISS << endl << "SIM_"  << cache->NAME << "PREFETCH_HITRATE : " << setw(10) << ((double)PREFETCH_HIT)/PREFETCH_ACCESS << endl;
    
    cout << endl;
    cout << "SIM_"  << cache->NAME << "WRITEBACK_ACCESS : " << setw(10) << WRITEBACK_ACCESS << endl << "SIM_"  << cache->NAME << "WRITEBACK_HITS : " << setw(10) << WRITEBACK_HIT << endl <<  "SIM_"  << cache->NAME << "WRITEBACK_MISSES : " << setw(10) << WRITEBACK_MISS << endl << "SIM_"  << cache->NAME << "WRITEBACK_HITRATE : " << setw(10) << ((double)WRITEBACK_HIT)/WRITEBACK_ACCESS << endl;
    cout << " ------------ " << endl;
}
...
void print_branch_stats()
{
    for (uint32_t i=0; i<NUM_CPUS; i++) {
        cout << endl << "CPU_" << i << "_Branch Prediction Accuracy : " << (100.0*(ooo_cpu[i].num_branch - ooo_cpu[i].branch_mispredictions)) / ooo_cpu[i].num_branch << endl;
        cout << "CPU_" << i << "_MPKIPERCENT : " << (1000.0*ooo_cpu[i].branch_mispredictions)/(ooo_cpu[i].num_retired - ooo_cpu[i].warmup_instructions) << endl;
        cout << "CPU_" << i << "_Average_ROB_Occupancy_at_Mispredict : " << (1.0*ooo_cpu[i].total_rob_occupancy_at_branch_mispredict)/ooo_cpu[i].branch_mispredictions << endl << endl;
        
        cout << "CPU_" << i << "Branch_types" << endl;
        cout << "CPU_" << i << "NOT_BRANCH_PERCENT_PERCENT: " << (100.0*ooo_cpu[i].total_branch_types[0])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) << endl;
        cout << "CPU_" << i << "BRANCH_DIRECT_JUMP_PERCENT : " << (100.0*ooo_cpu[i].total_branch_types[1])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) << endl;
        cout << "CPU_" << i << "BRANCH_INDIRECT_PERCENT : " << (100.0*ooo_cpu[i].total_branch_types[2])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) << endl;
        cout << "CPU_" << i << "BRANCH_CONDITIONAL_PERCENT : " << (100.0*ooo_cpu[i].total_branch_types[3])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) << endl;
        cout << "CPU_" << i << "BRANCH_DIRECT_CALL_PERCENT : " << (100.0*ooo_cpu[i].total_branch_types[4])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) << endl;
        cout << "CPU_" << i << "BRANCH_INDIRECT_CALL_PERCENT : " << (100.0*ooo_cpu[i].total_branch_types[5])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) << endl;
        cout << "CPU_" << i << "BRANCH_RETURN_PERCENT : " << (100.0*ooo_cpu[i].total_branch_types[6])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) << endl;
        cout << "CPU_" << i << "BRANCH_OTHER_PERCENT : "  << (100.0*ooo_cpu[i].total_branch_types[7])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) << endl << endl;
    }
}
...
{
    cout << endl;
    cout << "DRAM_Statistics" << endl;
    for (uint32_t i=0; i<DRAM_CHANNELS; i++) {
        cout << "DRAM_CHANNEL_" << i << endl;
        cout << "DRAM_RQ ROW_BUFFER_HIT_" << i << " : " << std::dec << setw(10) << uncore.DRAM.RQ[i].ROW_BUFFER_HIT << endl;
        cout << "DRAM_RQ_ROW_BUFFER_MISS_" << i << " : " << std::dec << setw(10) << uncore.DRAM.RQ[i].ROW_BUFFER_MISS << endl;
        cout << "DRAM_DBUS_CONGESTED_" << i << " : " << std::dec << setw(10) << uncore.DRAM.dbus_congested[NUM_TYPES][NUM_TYPES] << endl;
        cout << "DRAM_WQ_ROW_BUFFER_HIT_" << i << " : " << std::dec << setw(10) << uncore.DRAM.WQ[i].ROW_BUFFER_HIT << endl;
        cout << "DRAM_WQ_ROW_BUFFER_MISS_" << i << " : " << std::dec << setw(10) << uncore.DRAM.WQ[i].ROW_BUFFER_MISS << endl;
        cout << "DRAM_WQ_FULL_" << i << " : " << std::dec << setw(10) << uncore.DRAM.WQ[i].FULL << endl;
        cout << "DRAM_READS" << i << " : " << std::dec << setw(10) << (uncore.DRAM.RQ[i].ROW_BUFFER_HIT + uncore.DRAM.RQ[i].ROW_BUFFER_MISS) << endl;
        cout << "DRAM_WRITES" << i << " : " << std::dec << setw(10) << (uncore.DRAM.WQ[i].ROW_BUFFER_HIT + uncore.DRAM.WQ[i].ROW_BUFFER_MISS) << endl;

        cout << "DRAM_READ_INTENSITY" << i << " : " << std::dec << setw(10) << ((double)(uncore.DRAM.RQ[i].ROW_BUFFER_HIT + uncore.DRAM.RQ[i].ROW_BUFFER_MISS))/(uncore.DRAM.RQ[i].ROW_BUFFER_HIT + uncore.DRAM.RQ[i].ROW_BUFFER_MISS + uncore.DRAM.WQ[i].ROW_BUFFER_HIT + uncore.DRAM.WQ[i].ROW_BUFFER_MISS) << endl;
        cout << "DRAM_WRITE_INTENSITY" << i << " : " << std::dec << setw(10) << ((double)(uncore.DRAM.WQ[i].ROW_BUFFER_HIT + uncore.DRAM.WQ[i].ROW_BUFFER_MISS))/(uncore.DRAM.RQ[i].ROW_BUFFER_HIT + uncore.DRAM.RQ[i].ROW_BUFFER_MISS + uncore.DRAM.WQ[i].ROW_BUFFER_HIT + uncore.DRAM.WQ[i].ROW_BUFFER_MISS) << endl;

        cout << "DRAM_ACCESSES" << i << " : " << std::dec << setw(10) << (uncore.DRAM.RQ[i].ROW_BUFFER_HIT + uncore.DRAM.RQ[i].ROW_BUFFER_MISS + uncore.DRAM.WQ[i].ROW_BUFFER_HIT + uncore.DRAM.WQ[i].ROW_BUFFER_MISS) << endl;
        cout << endl;
    }
    ...
    if (uncore.DRAM.dbus_congested[NUM_TYPES][NUM_TYPES])
        cout << "DRAM_AVG_CONGESTED_CYCLE : " << (total_congested_cycle / uncore.DRAM.dbus_congested[NUM_TYPES][NUM_TYPES]) << endl;
    else
        cout << "DRAM_AVG_CONGESTED_CYCLE : 0" << endl;
}
...
void finish_warmup()
{
    ...
    cout << endl;
    for (uint32_t i=0; i<NUM_CPUS; i++) {
        cout << "Warmup_CPU" << i << "_instructions : " << ooo_cpu[i].num_retired << endl;
        cout << "Warmup_CPU" << i << "_cycles : " << current_core_cycle[i] << endl;
...
int main(int argc, char** argv)
{
    ...
    while (1) {
        ...
        c = getopt_long_only(argc, argv, "wihsbvg", long_options, &option_index);
    ...
    for (int i=0; i<NUM_CPUS; i++) {
        ...
        //Ceviche Init
        uncore.LLC.CEVICHE = ceviche;
        uncore.LLC.STRATEGY = strategy;
    ...
    while (run_simulation) {
        ...
        for (int i=0; i<NUM_CPUS; i++) {
            ...
            if ((all_warmup_complete > NUM_CPUS) && (simulation_complete[i] == 0) && (ooo_cpu[i].num_retired >= (ooo_cpu[i].begin_sim_instr + ooo_cpu[i].simulation_instructions))) {
                ...
                cout << "Finished_CPU" << i << "_instructions : " << ooo_cpu[i].finish_sim_instr << endl;
                cout << "Finished_CPU" << i << "_cycles : " << ooo_cpu[i].finish_sim_cycle << endl;
                cout << "Cumulative_IPC" << i << " : " <<((float) ooo_cpu[i].finish_sim_instr / ooo_cpu[i].finish_sim_cycle) << endl;
                cout << " (Simulation time: " << elapsed_hour << " hr " << elapsed_minute << " min " << elapsed_second << " sec) " << endl;
    ...
    if (NUM_CPUS > 1) {
        ...
        for (uint32_t i=0; i<NUM_CPUS; i++) {
            cout << endl << "SIMCPU" << i << "_Cumulative_IPC : " << (float) (ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) / (current_core_cycle[i] - ooo_cpu[i].begin_sim_cycle) << endl;
            cout << "SIMCPU" << i << "_Instructions : " << ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr << endl;
            cout << "SIMCPU" << i << "_Cycles : " << current_core_cycle[i] - ooo_cpu[i].begin_sim_cycle << endl;
#ifndef CRC2_COMPILE
        ...
        print_sim_stats_llc(&uncore.LLC);
        uncore.LLC.llc_prefetcher_final_stats();
    }
    
    cout << endl << "Region of Interest Statistics" << endl;
    uint64_t cumulative_inst_all = 0;
    uint64_t cumulative_cycle_all = 0;

    for (uint32_t i=0; i<NUM_CPUS; i++) {
        cout << endl << "ROICPU" << i << "_Cumulative_IPC : " << ((float) ooo_cpu[i].finish_sim_instr / ooo_cpu[i].finish_sim_cycle) << endl;
        cout << "ROICPU" << i << "_Instructions : " << ooo_cpu[i].finish_sim_instr << endl;
        cout << "ROICPU" << i << "_Cycles : " << ooo_cpu[i].finish_sim_cycle << endl;
#ifndef CRC2_COMPILE
        ...
        cout << "Major_fault: " << major_fault[i] << endl << " Minor_fault: " << minor_fault[i] << endl;
        cumulative_inst_all += ooo_cpu[i].finish_sim_instr;
        cumulative_cycle_all += ooo_cpu[i].finish_sim_cycle;
    }
    cout << endl << "--------------------- " << endl;
    cout << endl << "ROI_Cumulative_IPC : " << ((float) cumulative_inst_all/cumulative_cycle_all) << endl;
    cout << "ROICPU_Instructions : " << cumulative_inst_all << endl;
    cout << "ROICPU_Cycles : " << cumulative_cycle_all << endl;

    cout << endl << "--------------------- " << endl;

    print_roi_stats_llc(&uncore.LLC);

    cout << endl << "--------------------- " << endl;

    uncore.LLC.llc_profile_final_stats();

    for (uint32_t i=0; i<NUM_CPUS; i++) {
        ooo_cpu[i].l1i_prefetcher_final_stats();
        ooo_cpu[i].L1D.l1d_prefetcher_final_stats();
        ooo_cpu[i].L2C.l2c_prefetcher_final_stats();
        //ooo_cpu[i].close_file();
    }
    uncore.LLC.llc_prefetcher_final_stats();
